        ...
        <div className="flex flex-wrap items-start justify-start  w-full h-full ">
          {numbers.map((number: number) => {
            return (
              <div
                key={number}
                className="flex ml-20 mt-10 items-start justify-start flex-col"
              >
          ...
          <div className="bg-white h-auto w-96 p-4 flex items-center justify-start flex-col rounded shadow-lg">
            ...
            {loginpage === 'home' ? (
              <>
                ...
                <button
                  className="border border-t-white border-r-white border-l-white mt-5 font-bold  border-b-black"
