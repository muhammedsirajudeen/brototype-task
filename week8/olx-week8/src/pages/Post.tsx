    ...
    <div className="flex flex-col items-center justify-center bg-white mt-2 p-10">
      ...
      <div className="w-image h-auto border border-gray-300 flex flex-col p-5">
        <form className="flex flex-col" onSubmit={postHandler}>
          ...
          <label className="text-xs text-borderedgecolor mt-4" htmlFor="brand">
            Brand*
          </label>
          <input
            id="brand"
          ...
          <label className="text-xs text-borderedgecolor mt-4" htmlFor="model">
            Model*
          </label>
          <input
            id="model"
          ...
          <label className="text-xs text-borderedgecolor mt-4" htmlFor="owners">
            Number of Owners*
          </label>
          <input
            id="owners"
          ...
          <label className="text-xs text-borderedgecolor mt-4" htmlFor="title">
            Ad Title*
          </label>
          <input
            id="title"
          ...
          <label className="text-xs text-borderedgecolor mt-4" htmlFor="price">
            Price*
          </label>
          <input
            id="price"
